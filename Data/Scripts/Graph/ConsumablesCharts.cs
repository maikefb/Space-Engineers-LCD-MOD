...
namespace Graph.Data.Scripts.Graph
{
    ...
    public class ConsumablesCharts : MyTextSurfaceScriptBase
    {
        ...
        private static readonly Regex RxSection = new Regex(@"\[ConsumablesCharts\](.*?)(?:\r?\n\r?\n|\Z)", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        ...
        public override void Run()
        {
            using (var frame = Surface.DrawFrame())
            {
                ...
                var pos = INFO_POS;
                sprites.Add(Text("Estoque de consumíveis", pos, 0.85f));
