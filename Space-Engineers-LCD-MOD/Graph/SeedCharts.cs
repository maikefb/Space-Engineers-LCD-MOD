...
{
    [MyTextSurfaceScript("SeedCharts", "Sementes")]
    public class SeedCharts : ItemCharts
    {
        
        public override Dictionary<string, double> ItemSource => GridLogic?.Seeds;
        ...
        private static readonly Regex RxSection = new Regex(@"\[SeedCharts\](.*?)(?:\r?\n\r?\n|\Z)", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        ...
        public override void Run()
        {
            ...
            using (var frame = Surface.DrawFrame())
            {
                ...
                var pos = INFO_POS;
                sprites.Add(Text("Estoque de sementes", pos, 0.85f));
