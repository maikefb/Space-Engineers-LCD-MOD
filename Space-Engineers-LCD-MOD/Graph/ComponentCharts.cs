...
namespace Graph.Data.Scripts.Graph
{
    ...
    {
        public override Dictionary<string, double> ItemSource => GridLogic != null ? GridLogic.Components : null;
        ...
        public override void Run()
        {
            ...
            using (var frame = Surface.DrawFrame())
            {
                ...
                var pos = INFO_POS;
                sprites.Add(MakeText(Surface, "Estoque de componentes", pos, 0.85f));
