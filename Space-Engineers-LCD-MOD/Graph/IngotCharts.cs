...
namespace Graph.Data.Scripts.Graph
{
    ...
    {
        public override Dictionary<string, double> ItemSource => GridLogic?.Ingots;
        ...
        private static readonly Regex RxSection = new Regex(@"\[IngotCharts\](.*?)(?:\r?\n\r?\n|\Z)", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        ...
        public override void Run()
        {
            ...
            using (var frame = Surface.DrawFrame())
            {
                ...
                var pos = INFO_POS;
                sprites.Add(Text("Estoque de lingotes", pos, 0.85f));
