...
{
    /// <summary>
    /// Ensures settings is corectly Save/Loaded and Synced between clients
    /// </summary>
    public static class ConfigManager
    {
        ...
        {
            MyLog.Default.Log(MyLogSeverity.Info, $"{nameof(Space_Engineers_LCD_MOD)}: Setting up Network Manager using port {Constants.PORT}");
        ...
        {
            MyLog.Default.Log(MyLogSeverity.Info, $"{nameof(Space_Engineers_LCD_MOD)}: Closing Network Manager");
