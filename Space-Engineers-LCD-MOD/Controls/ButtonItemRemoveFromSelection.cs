...
{
    public class ButtonItemRemoveFromSelection : TerminalControlsCharts
    {
        ...
        public ButtonItemRemoveFromSelection(TerminalControlsListboxCharts sourceList, TerminalControlsListboxCharts targetList)
        {
            ...
            _removeFromListboxButton =
                MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlButton, IMyTerminalBlock>(
                    "ItemChartRemoveItemFromSelection");
            _removeFromListboxButton.Action = Action;
            _removeFromListboxButton.Visible = Visible;
            _removeFromListboxButton.Title = MyStringId.GetOrCompute("BlockPropertyTitle_ConveyorSorterRemove");
        }
